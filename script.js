...
const translations = {
    en: {
        ...
        about_text1: 'I am a Computer Vision and Deep Learning Developer specializing in facial recognition systems and 3D face modeling. Currently working on innovative solutions in the field of computer vision, with a focus on diffusion models and texture completion techniques.',
        about_text2: 'I worked as an IT and Web Developer at ITU Cezeri UAV Team. My recent achievements include securing 3rd place in Anadolu Agency\'s National Hackathon with a face recognition system, and presenting research on texture completion using diffusion models at the GITMA Conference.',
    ...
    tr: {
        ...
        about_text1: 'Yüz tanıma sistemleri ve 3D yüz modellemesi konusunda uzmanlaşmış bir Bilgisayarlı Görü ve Derin Öğrenme Geliştiricisiyim. Şu anda bilgisayarlı görü alanında, difüzyon modelleri ve doku tamamlama teknikleri üzerine yenilikçi çözümler geliştiriyorum.',
        about_text2: 'İTÜ Cezeri İHA Takımı\'nda IT ve Web Geliştiricisi olarak çalıştım. Son başarılarım arasında Anadolu Ajansı\'nın Ulusal Hackathon\'unda yüz tanıma sistemiyle 3.lük ve GITMA Konferansı\'nda difüzyon modelleri kullanarak doku tamamlama üzerine araştırmamın sunumu yer alıyor.',
    ...
    de: {
        ...
        about_text1: 'Ich bin ein Computer Vision und Deep Learning Entwickler, spezialisiert auf Gesichtserkennungssysteme und 3D-Gesichtsmodellierung. Derzeit arbeite ich an innovativen Lösungen im Bereich Computer Vision, mit Fokus auf Diffusionsmodelle und Texturvervollständigungstechniken.',
        about_text2: 'Ich habe als IT- und Webentwickler beim ITU Cezeri UAV Team gearbeitet. Zu meinen jüngsten Erfolgen gehören der 3. Platz beim National Hackathon der Anadolu Agency mit einem Gesichtserkennungssystem und die Präsentation meiner Forschung zur Texturvervollständigung mit Diffusionsmodellen auf der GITMA-Konferenz.',
